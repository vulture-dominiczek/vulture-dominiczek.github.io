...
<div style="display: flex; margin:0; padding: 0; height: 100vh">
    <div style="width:50%">
        <img src="/me.jpg" height=100% style="object-fit: cover"></img>
    </div>
    <div style="width:50%; height: 100%; display: flex; flex-direction: column; justify-content: center;">
        <div style="display:flex; flex-direction: column; align-items: center;">
            <h1>Dominik Gawlik</h1>
            <h3>dominik.gawlik1@gmail.com</h3>
            <h1>
